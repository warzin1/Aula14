...
package br.usjt.arqdesis.atividades.util;
...
public class Utils {
    ...
    private static br.usjt.arqdesis.atividades.util.StatusTracker mStatusTracker = br.usjt.arqdesis.atividades.util.StatusTracker.getInstance();
